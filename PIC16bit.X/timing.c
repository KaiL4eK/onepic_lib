...
void delay_ms ( uint16_t time_ms )
{
    ...
    T1CONbits.TCKPS = 0b10;    // Настройка на делителе 64
    PR1 = FCY/64/1000;          // Расчет на работу таймера до переполенния в течении 1 мс
                                // 250 = 32MHz / 2 / 64 / 1 * 0.001 sec
    _T1IE = 1;
